...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread().run(){
            btnEf.buttonEffect(btn_accept_location_edit)
        }
        btn_accept_location_edit.setOnClickListener { v->
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        uref.addValueEventListener( object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@MapsActivity, "not read", Toast.LENGTH_LONG).show()
            }
        })
